...
import { Send, ArrowLeft, MoreVertical, Search, Paperclip, Smile, MessageCircle } from 'lucide-react';
...
const Chat = () => {
  ...
  useEffect(() => {
    async function loadConversations() {
      ...
      const msgs = await getConversations(currentUserId)
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-baseline">
                      <h3 className="font-semibold text-white truncate">{conv.user2_id}</h3>
                    </div>
                    <div className="flex justify-between items-center">
                      <p className="text-sm text-gray-400 truncate">{conv.messages.content}</p>
                      {conv.unreadCount > 0 && (
            ...
            <div className="flex-1 flex flex-col bg-black">
              ...
              <div className="bg-gray-900 p-4 flex items-center gap-3 border-b border-gray-800">
                ...
                <div className="flex-1">
                  <h2 className="font-semibold text-white">{selectedConversation.user2_id}</h2>
                  ...
                  return (
                    <div key={msg.id}>
                      ...
                      <div className={`flex ${isMyMessage ? 'justify-end' : 'justify-start'}`}>
                        <div
                          className={`max-w-xs md:max-w-md lg:max-w-lg px-4 py-2 rounded-lg shadow-lg ${isMyMessage
                          ...
                          <div className="flex items-center justify-end gap-1 mt-1">
                            ...
                            {isMyMessage && (
                              <svg
                                ...
                                width="16"
                                height="15"
                                className={msg.isRead ? 'text-blue-500' : 'text-gray-600'}
                              >
                                <path
                                  fill="currentColor"
